...
public class EventTicket extends Pass {
  ...
  public EventTicket(PassDo dbo) throws IOException {
    super(dbo);
  }
   ...
   * @return the coupon
   */
  public DictionaryKeys getEventTicket() {
    return this.fields;
  }
   ...
   */
  public void setEventTicket(DictionaryKeys coupon) {
    this.fields = coupon;
  }
  ...
  public String getPassType() {
    return PassTypeEnum.eventTicket.name();
  }
